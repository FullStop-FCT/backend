...
//		LOG.warning("we're here");
		...
		((HttpServletResponse) servletResponse).addHeader("Access-Control-Allow-Headers", "Origin, Accept, Content-Type, X-Request-With, Authorization, On-behalf-of, x-sg-elas-acl");
